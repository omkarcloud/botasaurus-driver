...
def perform_get_element_at_point(x: int, y: int, child_selector: Optional[str], wait: Optional[int], driver):
    """
    ...
    el = make_element(driver, driver._tab, elem) if elem else None
